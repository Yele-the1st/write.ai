    ...
    <div data-dial-init class="fixed right-6 bottom-6 group">
      ...
      >
        <button
          ...
          class="flex justify-center items-center w-[52px] h-[52px] text-gray-500 hover:text-gray-900 bg-white rounded-lg border border-gray-200  shadow-sm  hover:bg-gray-50   focus:ring-4 focus:ring-gray-300 focus:outline-none "
        >
          <svg
            aria-hidden="true"
            class="w-6 h-6 -ml-px "
      ...
      <button
        ...
        class="flex items-center justify-center text-white bg-[#660080] rounded-lg w-14 h-14 hover:bg-gray-300 focus:ring-4 focus:ring-blue-300 focus:outline-none "
      >
        <svg
          aria-hidden="true"
